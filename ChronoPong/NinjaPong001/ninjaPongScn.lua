...
function scene:create( event )
    ...
    local sceneGroup = self.view
        ...
        --[[trail1ball = display.newCircle(sceneGroup, 200,  200 , 11)
        trail2ball = display.newCircle(sceneGroup, 200,  200 , 4)
        physics.addBody( trail1ball, "kinematic", {density=0, friction=0, bounce=0 } )
        physics.addBody( trail2ball, "kinematic", {density=0, friction=0, bounce=0 } )
        trail1ball.touchJoint = physics.newJoint( "touch", trail1ball, trail1ball.x,trail1ball.y )
        trail2ball.touchJoint = physics.newJoint( "touch", trail2ball, trail2ball.x,trail2ball.y )
        

        local asde = 2
        print( trail2ball.touchJoint )
        ]]--
